...
export default function Navbar() {
  ...
  return (
    <div className='fixed w-full right-0 left-0 border-b-2 z-10'>
      ...
      <div className='container flex items-center justify-between px-2 py-6 relative overflow-hidden'>
        ...
        <div className={`fixed bottom-0 top-0 flex flex-col bg-white transition-transform duration-500 ${!menu ? '-right-full' : 'left-0 right-0 lg:hidden'}`}>
