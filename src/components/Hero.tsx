...
export default function Hero() {
  return (
    <div className='pt-36 flex items-center justify-between lg:flex-row flex-col gap-y-10'>
        <div className='flex flex-col gap-6 lg:items-start items-center lg:p-0 p-4'>
