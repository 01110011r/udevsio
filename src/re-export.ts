...
export const technologies = [
    ...
    {type: "Mobile", logo: kotlin, name: "Kotlin", bg: "#F4F7FF"},
    {type: "Mobile", logo: android, name: "Android", bg: "#F4F7FF"},
    {type: "Mobile", logo: java, name: "Java", bg: "#F4F7FF"},
    ...
    {type: "Mobile", logo: ios, name: "IOS", bg: "#F4F7FF"},
    {type: "Mobile", logo: swift, name: "Swift", bg: "#F4F7FF"},
    {type: "Mobile", logo: flutter, name: "Flutter", bg: "#F4F7FF"},
